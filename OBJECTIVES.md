# AIHACK - Objetivos del Proyecto

## Vision General

**AIHACK** es una herramienta CLI de pentesting potenciada por IA local (Ollama, LM Studio, Llama.cpp). El objetivo es crear un asistente de seguridad autonomous y completo que pueda ejecutar herramientas, investigar, mejorar codigo y adaptarse al modo de trabajo seleccionado.
