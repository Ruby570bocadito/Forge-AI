"""CLI commands using Typer for AIHACK."""
...
app = typer.Typer(help="AIHACK CLI Commands")
console = Console()
...
def version() -> None:
    ...
    console.print("[bold]AIHACK v2.0.0[/bold]")
    console.print("AI-Powered Pentesting Suite")
