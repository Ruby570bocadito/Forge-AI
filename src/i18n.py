"""Internationalization (i18n) for AIHACK."""
...
MESSAGES = {
    "en": {
        "app_title": "AIHACK",
        "app_subtitle": "AI-Powered Pentesting Suite",
        "welcome": "Welcome to AIHACK",
