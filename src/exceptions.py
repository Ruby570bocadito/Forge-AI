"""Global error handling for AIHACK."""
...
logger = get_logger("aihack.errors")
console = Console()

T = TypeVar("T")


class AIHACKException(Exception):
    """Base exception for AIHACK."""
...
class ValidationError(AIHACKException):
    """Validation error."""
    pass


class ScanError(AIHACKException):
    """Scan execution error."""
    pass


class ToolNotFoundError(AIHACKException):
    """Tool not found error."""
    pass


class ConfigurationError(AIHACKException):
    """Configuration error."""
    pass


class APIError(AIHACKException):
    """API error."""
    pass
