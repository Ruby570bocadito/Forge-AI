...
app = typer.Typer(help="AIHACK - AI-Powered Pentesting Suite")
console = Console()
...
def print_banner(show_mode=True):
    ...
    if show_mode:
        ...
        console.print(BANNER.format(
            mode_name="AIHACK",
            mode_desc="AI-Powered Pentesting Suite",
...
def show_help():
    help_text = """
[bold #00FF88]╔══════════════════════════════════════════════════════════════════════╗[/]
[bold #00FF88]║                    AIHACK - AI-POWERED PENTESTING SUITE                         ║[/]
...
def main(
    ...
    console.print(Panel(
        "\n".join(menu_lines),
        title=f"[bold {SECONDARY}]AIHACK - {current_model[:30]}[/]",
        border_style=TEXT_MUTED,
        box=box.ROUNDED,
        padding=(0, 2)
    ))
