"""Logging configuration for AIHACK."""
...
class AIHackLogger:
    """Custom logger for AIHACK with structured logging."""
    ...
    def __init__(
        ...
        config = get_config()
        default_log_file = Path(config.paths.audit_log) if hasattr(config.paths, 'audit_log') else Path("aihack.log")
...
def get_logger(name: str = "aihack", level: str = "INFO") -> AIHackLogger:
    """Get or create a logger instance."""
    return AIHackLogger(name=name, level=level)
